...
const page = () => {
  ...
  return (
    <div className="flex background_color flex-col  min-h-screen pt-20 ">
      ...
      <div className="flex w-full justify-between gap-5 flex-row px-14 ">
        <form
          action="https://formsubmit.co/ashishviradiya153@gmail.com"
          method="post"
        >
          <div className="flex flex-col gap-14 mt-6 flex-1 pl-10 text-white ">
        ...
        <div className="flex flex-1 flex-col pr-10 pb-24">
          <div className="flex w-full  flex-row flex-1 shrink-0">
          ...
          <div className="flex justify-center flex-1 shrink-0 items-center">
